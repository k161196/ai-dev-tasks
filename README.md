...
3. **Create custom commands** (optional): For easier access, create these files in `.claude/commands/`:
   ...
   - `.claude/commands/generate-tasks.md` with content:
     ...
     - assume it's stored under `/tasks/[n]-[feature-name]/` with a filename format `[n]-prd-[feature-name].md` or `[n]-frd-[feature-name].md` (e.g., `/tasks/0001-user-auth/0001-prd-user-auth.md`)
     - it should not already have a corresponding task list in the same directory (e.g., `tasks-0001-prd-user-auth.md`)
